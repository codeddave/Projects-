 ...
 var budgetController =  (function() {
    ...
    return {
        addItem: function (type, des, val){
            ...
            // To create new item based on if the type is either "inc" or "exp"
            if (type === "exp") {
        ...
        return {
            getInput: function () {
                ...
                addListItem: function(obj, type){
                    ...
                    // Create HTML striing with placeholder text
...
var appController = (function(budgetctrl, UIctrl){
        ...
        var updatePercentages = function(){
            ...
            // Read the percentage from  the UI controller
